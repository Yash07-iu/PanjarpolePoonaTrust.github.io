...
(function() {
  ...
  form.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      const response = await chatGPT.getResponse(userMsg);
      await addBotMessageWithTyping(response);
    } catch (error) {
      console.error('Error in chatbot:', error);
      await addBotMessageWithTyping('I apologize, but I am currently unable to process your request. Please try again later or contact us directly.');
    }
  });
